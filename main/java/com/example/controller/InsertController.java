...
public class InsertController {
	...
	public String resultlogin(@Validated @ModelAttribute("insert") InsertForm form, BindingResult bindingResult,
			Model model) {
	...
	public String resultbuy(@Validated @ModelAttribute("detail") BuyListForm form, BindingResult bindingResult,
			Model model) {
		...
		BuyList buyList = new BuyList(user.getName(), form.getProductId(), form.getCategoryId(), form.getName(),
				form.getPrice(), form.getImg());
	...
	public String resultbuyuser(@Validated @ModelAttribute("detail") BuyListForm form, BindingResult bindingResult,
			Model model) {
		System.out.println("通った");
