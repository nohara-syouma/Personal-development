				...
				<fieldset class="label-130 product_block">
					...
					<div>
						...
						<form:input type="text" path="name"
							value="${ productdetail.name }" readonly="true" class="base-text" />
					</div>
					<div>
						<label>単価</label>
						<form:input type="text" path="price"
							value="${ productdetail.price }" readonly="true"
							class="base-text" />
					</div>
					<div>
						<label>カテゴリ</label>
						<form:input type="text" path="categoryId"
							value="${ productdetail.categoryId }" readonly="true"
							class="base-text" />
					</div>
					<div>
						<label>画像</label>
						<form:input type="text" path="img" value="${ productdetail.img }"
							readonly="true" class="base-text" />
					</div>
					<div>
						<label>商品説明</label>
				...
				<div>
					<div class="btns">
						<input type="button" name="buy" onclick="openModal()" value="購入"
							class="basic_btn" /> <a href="menu2" class="cancel_btn">戻る</a>
					</div>
					<div id="modal">
